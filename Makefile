...
RASPBERRY_SRCS = $(RASPBERY_CPP_REPO)/main.cc $(RASPBERY_CPP_REPO)/I2C/src/victorI2cMaster.cc $(RASPBERY_CPP_REPO)/Socket/src/victorServer.cc
RASPBERRY_INCS = -I $(RASPBERY_CPP_REPO)/I2C/inc/ -I $(RASPBERY_CPP_REPO)/Socket/inc/ -I $(RASPBERY_CPP_REPO)/
